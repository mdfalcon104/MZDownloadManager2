...
Pod::Spec.new do |s|
  ...
  s.homepage         = "https://github.com/mdfalcon104/MZDownloadManager2"
  ...
  s.source           = { :git => "https://github.com/mdfalcon104/MZDownloadManager2.git", :tag => s.version }
